...
//shuffle questions
function shuffleQuestions(array: any[]): any[] {
    return [...array].sort(() => Math.random() - 0.5);
}

//returns array of questions type Question for each player
export function getQuestions(questions: Question[], players: number): Question[][] {
    ...
    const selectedQuestions: Question[][] = Array.from({ length: players }, () => []); //create array with length of players and empty content
